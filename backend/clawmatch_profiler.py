...
def interactive_interview():
    ...
    profile = {
        ...
        "public": {"summary": public_summary, "tags": public_tags},
        "private": {"constraints": private_constraints, "agent_contact": private_contact},
        "meta": {"generator": "clawborate_profiler_v2_auto"},
    }
    ...
    if submit == "y":
        ...
        data = {"title": f"[PROFILE] {project_name}", "body": f"```json\n{json_body}\n```", "labels": ["profile"]}
